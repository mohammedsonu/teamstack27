							...
							<div class="col-md-6">
								...
								<p class="ml-2 d-list">
									...
									<?php if ($_SESSION['login_type'] != 3): ?>
										<span class="badge btn-outline-primary btn update_status"
											data-id='<?php echo $id ?>'>Update Status</span>
									<?php endif; ?>
								</p>
								<label for="" class="control-label border-bottom border-primary">Need Support
									From</label>
								<p class="ml-2 d-list"><b>
										<?php echo $dname ?>
									</b></p>
								...
								<div class="card-header">
									...
									<div class="card-tools">
										...
										<?php if ($row['user_type'] == $_SESSION['login_type'] && $row['user_id'] == $_SESSION['login_id']): ?>
											<span class="dropleft">
												<a class="fa fa-ellipsis-v text-muted" href="javascript:void(0)"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
												<div class="dropdown-menu" style="">
													<a class="dropdown-item edit_comment" href="javascript:void(0)"
														data-id="<?php echo $row['id'] ?>">Edit</a>
													<div class="dropdown-divider"></div>
													<a class="dropdown-item delete_comment" href="javascript:void(0)"
					...
					<div class="px-2">
						<form action="" id="manage-comment">
							<div class="form-group">
								...
								<textarea name="comment" id="" cols="30" rows=""
									class="fom-control summernote2"></textarea>
							</div>
